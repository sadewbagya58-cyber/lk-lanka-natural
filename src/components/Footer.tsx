    ...
    <footer className="w-full bg-slate-900 border-t border-slate-800 pt-16 pb-10 text-slate-400" aria-label="Global marketplace footer">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 pb-12 border-b border-slate-800">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-2.5 text-sm">
            <li>
              <Link href="/track-order" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                Track Your Order
              </Link>
            </li>
            <li>
              <Link href="/shipping-policy" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                Shipping &amp; Delivery
              </Link>
            </li>
            <li>
              <Link href="/returns-refunds" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                Returns &amp; Refunds
              </Link>
            </li>
            <li>
              <Link href="/faq" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                Frequently Asked FAQs
              </Link>
            </li>
            <li>
              <Link href="/contact" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                Help Center
              </Link>
            </li>
          </ul>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-3 text-sm">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+94112345678" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                +94 11 234 5678
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-emerald-500 shrink-0" />
              <a href="mailto:support@kllankanatural.lk" className="hover:text-emerald-500 hover:underline transition-colors focus:outline-none">
                support@kllankanatural.lk
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-slate-500">
        <div className="flex flex-col md:flex-row items-center gap-2 md:gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-4">
            <Link href="/privacy-policy" className="hover:text-slate-350 hover:underline transition-colors focus:outline-none">
              Privacy Policy
            </Link>
            <Link href="/terms-of-service" className="hover:text-slate-350 hover:underline transition-colors focus:outline-none">
              Terms of Service
            </Link>
          </div>
        </div>
