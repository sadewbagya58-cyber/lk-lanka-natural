...
import type { SubCategory, ProductCardData, SortOption } from '@/data/types';
import { queryProducts } from '@/data';
...
export default function CategoryView({ category, iconNode }: CategoryViewProps) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return res.items;
  }, [activeSubCategory, sortBy, category.slug]);
        ...
        {filteredProducts.length > 0 ? (
          ...
          >
            ...
            <p className="text-slate-500 max-w-md">
              We couldn&apos;t find any products in this subcategory matching your filters. Try selecting a different filter or checking back later.
            </p>
            <button 
              onClick={() => {
